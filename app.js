...
const fileName = `Quote-${nameInput || data.customer || 'Unknown'}-${Date.now()}.json`;
  ...
  await fetch("https://defaultfd6501db952940d2bfb6372e71418092.environment.api.powerplatform.com:443/powerautomate/automations/direct/workflows/53b871a031904d778e5afc598438bfa2/triggers/manual/paths/invoke?api-version=1&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=rJ79JZvpgqiFIvIbkvDdqiOvN-7mbF4XiTVaNKXjfzI", {
      method: "POST",
      body: JSON.stringify({
        fileName: fileName,
